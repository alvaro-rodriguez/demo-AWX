...
{
    // default connection
    public static $dbname = 'xcrub'; // Your database name
    public static $dbuser = 'rimadmin'; // Your database username
    ...
    // alert settings
    public static $email_from = 'juanj.guerra@fujitsu.es'; // email from address
    public static $email_from_name = 'Fujitsu RIM Sevilla'; // email from name
